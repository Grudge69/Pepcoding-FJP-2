...
function parseHtml(html) {
  ...
  let bothTheTeams = MyDocument.querySelectorAll(
    ".match-header-container .name-link"
  );
  let WinningTeamName;
  ...
  let venueSelector = MyDocument.querySelector(
    ".match-header-info.match-info-MATCH  .description"
  );
...
///// STORE FILE IN EXCEL FOLLOWING THIS: https://www.youtube.com/watch?v=UB8SUwrZg6M&list=PL-Jc9J83PIiEeD3I4VXETPDmzJ3Z1rWb4&index=20&t=2s
